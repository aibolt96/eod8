...
// CODE HERE
const divideTwo = numbers.map(number => number / 2)
...
fruits.forEach((el) => {
  if (el.color === 'red'){
    console.log(`The fruit with the index ${fruits.indexOf(el)} is an apple`)
  } else if (el.color === 'orange') {
    console.log(`The fruit with the index ${fruits.indexOf(el)} is an orange`)
  } else {
    console.log(`The fruit with index ${fruits.indexOf(el)} is neither apple nor orange`)
  }
})
